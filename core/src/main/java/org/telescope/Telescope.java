...
import org.telescope.internal.Beans;
import org.telescope.internal.Records;
import org.telescope.internal.optics.Iso;
import org.telescope.internal.optics.Lens;
import org.telescope.internal.optics.Prism;
import org.telescope.internal.optics.Traversal;
import org.telescope.internal.optics.collections.Traversals;
import org.telescope.internal.optics.instances.CompletableFutureK;
import org.telescope.internal.optics.instances.EitherK;
import org.telescope.internal.optics.instances.OptionalK;
import org.telescope.internal.optics.instances.ValidatedK;
 ...
 * org.telescope.internal.optics}. Each navigation method builds the appropriate optic ({@link Lens}
 * for fields, {@link Prism} for sealed cases, {@link Traversal} for collections) and composes it
 * via the lattice's {@code .then(...)} rules. Operations ({@code read}, {@code update}, {@code
 * set}, {@code toList}) delegate to the underlying optic. Users never see those types directly.
 */
public final class Telescope<S, A> {
   ...
   * org.telescope.annotations.BeanFocus}.
   *
   ...
   * factory used by {@link org.telescope.annotations.Focus}-generated {@code *Focus} classes; it's
   * also useful when you want a typed accessor for a non-record type or want to skip the reflection
   * cost on a hot path.
   *
   ...
   * }</pre>
   *
   * @see org.telescope.annotations.Focus
   * @see #of(Class)
   */
  ...
  public static final class BeanTo<P, R extends Record> {
     ...
     * org.telescope;} to that module's {@code module-info.java}. The other two strategies, which go
     * through public constructors/builders, don't need this.
     *
     * <pre>{@code
     * final var bridge = Telescope.fromBean(LegacyUser.class).to(UserRecord.class).viaFields();
     * }</pre>
