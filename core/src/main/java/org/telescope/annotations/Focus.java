 ...
 * {@link org.telescope.Telescope#lens(java.util.function.Function, java.util.function.BiFunction)}.
 *
 ...
 * The constants are plain {@link org.telescope.Telescope} values, so they compose with {@code
 * .field(...)}, {@code .each(...)}, {@code .then(...)} like any other telescope.
 *
 ...
 * }</pre>
 *
 * @see org.telescope.Telescope#lens(java.util.function.Function, java.util.function.BiFunction)
 */
