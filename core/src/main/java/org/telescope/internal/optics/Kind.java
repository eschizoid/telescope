 ...
 *
 * <p>Internal to the library. Users of {@link org.telescope.Telescope} never see {@code Kind}: the
 * four {@code update*} methods box and unbox at the boundary, so the user-facing types are JDK
 * standards ({@link java.util.concurrent.CompletableFuture}, {@link java.util.Optional}) and the
 * library's own {@link org.telescope.Either} / {@link org.telescope.Validated}.
 *
