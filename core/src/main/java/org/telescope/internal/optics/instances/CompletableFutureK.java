 ...
 * org.telescope.internal.optics.Applicative} instance for {@link CompletableFuture} — the effect
 * lifted by {@link org.telescope.internal.optics.Traversal#modifyF}. Semantics: futures execute in
 * parallel (whatever schedule they already have); {@code pure} is a completed future, {@code map2}
 * waits for both via {@code thenCombine} and combines them, and failure of either propagates.
 *
 ...
 *
 * <p>Used by {@link org.telescope.Telescope#updateAsync}. The result {@code CompletableFuture<S>}
 * completes when every focused element's future has completed.
 */
