 ...
 * org.telescope.internal.optics.Focus} is an internal, non-instantiable utility class of factory
 * methods. It is unrelated to the planned public {@code @Focus} codegen annotation (v0.3); the name
 * collision is incidental.
 *
 * <p>If you're using the DSL via {@link org.telescope.Telescope} you almost never need this class;
 * the navigation methods build the right optics internally. It's here for extension points (custom
 * collection traversals, hand-tuned lenses for hot paths, codegen output in v0.3).
 */
