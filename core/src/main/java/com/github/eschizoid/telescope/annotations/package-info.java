 ...
 *
 * <ul>
 *   <li>{@link com.github.eschizoid.telescope.annotations.Focus} — applied to a record. The {@code
 ...
 *   <li>{@link com.github.eschizoid.telescope.annotations.BeanFocus} — the POJO counterpart of
 ...
 *       :lombok} processor).
 *   <li>{@link com.github.eschizoid.telescope.annotations.Bridge} — applied to a record to generate
 *       a reflection-free, compile-checked bridge to a sibling POJO; the runtime counterpart of
 *       {@link com.github.eschizoid.telescope.Telescope#fromBean}.
 * </ul>
 *
