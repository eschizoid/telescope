 ...
 * io.github.eschizoid.telescope.internal.optics.Applicative} instance for {@link Validated} fixed
 * to a specific error type {@code E} — the effect lifted by {@link
 * io.github.eschizoid.telescope.internal.optics.Traversal#modifyF}. Semantics: accumulate errors
