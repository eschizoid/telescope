 ...
 *
 * <p>This is the fast path for {@link io.github.eschizoid.telescope.Telescope#ofBean(Class)}: where
 * {@code ofBean} navigates a POJO reflectively (rebuilding the whole bean and re-reading every
 * getter at each level), the generated constants are reflection-free and compose at roughly the
