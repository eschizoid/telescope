 ...
 * builder-strategy {@link MultiPropBuilderLeaf}. Single-property so the off-path read (the shape
 * that previously NPE'd) is isolated to the hop-2 builder rebuild.
 */
@BeanFocus
