...
```kotlin
implementation("io.github.eschizoid:telescope-core:1.7.0")
annotationProcessor("io.github.eschizoid:telescope-codegen:1.7.0")
```
...
dependencies {
  ...
  annotationProcessor("io.github.eschizoid:telescope-lombok:1.7.0")
  annotationProcessor("io.github.eschizoid:telescope-codegen:1.7.0")
}
```
