...
```kotlin
implementation("io.github.eschizoid:telescope-core:1.6.0")
annotationProcessor("io.github.eschizoid:telescope-codegen:1.6.0")
```
...
dependencies {
  ...
  annotationProcessor("io.github.eschizoid:telescope-lombok:1.6.0")
  annotationProcessor("io.github.eschizoid:telescope-codegen:1.6.0")
}
```
