...
| `.observe(Consumer)`                                               | Run a callback for each value reached at this hop. Reads see current values; updates see rebuilt values. Failed effectful updates emit no callbacks.                                                                                                                                                                                                                                                                                                                                                                                              |
| `.observeAsync(Consumer, Executor, BiConsumer)`                    | Submit observations to an executor; report callback failures and rejection without waiting for completion.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
