...
/**
 * Entity-side mirror of {@code domain.InvoiceHeader}. Same bean property names ({@code number,
 * lines}) with the list element type swapped to {@link InvoiceLineEntity} — the codegen plan-fields
 * branch picks {@code LIST} with a sub-bridge reference to the user-declared {@code
 * InvoiceLineBridge}.
 */
@BeanFocus
