 ...
 * — carrying the nested {@link Address} record and the {@link Role} enum through by identity. Used
 * by {@link io.github.eschizoid.telescope.examples.graphql.server.NativeVerify} to exercise the
 * runtime deep record→record mapper (LMF readers + canonical-constructor rebuild) under
 * native-image.
 */
