 ...
 * FocusProcessor}. Discovers top-level annotated POJOs and dispatches to {@link
...
public final class BeanFocusProcessor extends AbstractTelescopeProcessor {
  ...
  private static final Set<String> TRIGGER = Set.of("org.telescope.annotations.BeanFocus");
