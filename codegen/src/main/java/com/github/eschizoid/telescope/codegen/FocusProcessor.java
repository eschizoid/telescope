...
/**
 * Annotation processor for {@link com.github.eschizoid.telescope.annotations.Focus}. For each
 ...
 * com.github.eschizoid.telescope.Telescope#lens(java.util.function.Function,
 ...
 * </ul>
 */
@SupportedAnnotationTypes("com.github.eschizoid.telescope.annotations.Focus")
...
public final class FocusProcessor extends AbstractTelescopeProcessor {
  ...
  public boolean process(final Set<? extends TypeElement> annotations, final RoundEnvironment roundEnv) {
    for (final Element element : roundEnv.getElementsAnnotatedWith(
      processingEnv.getElementUtils().getTypeElement("com.github.eschizoid.telescope.annotations.Focus")
    )) {
  ...
  private void emitComponentMethod(
    ...
    final var subFq = navigableType(compType, ElementKind.RECORD, "com.github.eschizoid.telescope.annotations.Focus");
    if (subFq != null) {
  ...
  private boolean isFocusAnnotatedRecord(final String qualifiedName) {
    ...
    final var anno = elements.getTypeElement("com.github.eschizoid.telescope.annotations.Focus");
