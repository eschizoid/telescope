...
dependencies {
    // The library under demonstration — depend on the latest published version. As of this
    // commit, v0.4.0 has just shipped with ADR-0006 Phases A-E.
    implementation("io.github.eschizoid:telescope:0.4.0")
