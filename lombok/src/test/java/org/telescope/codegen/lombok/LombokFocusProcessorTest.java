...
import org.telescope.codegen.lombok.fixtures.BuilderUser;
import org.telescope.codegen.lombok.fixtures.DataUser;
import org.telescope.codegen.lombok.fixtures.ValueBuilderUser;
...
class LombokFocusProcessorTest {
  ...
  class Generated {
    ...
    void dataPath() throws Exception {
      final var pathClass = Class.forName("org.telescope.codegen.lombok.fixtures.DataUserPath");
    ...
    void builderPath() throws Exception {
      final var pathClass = Class.forName("org.telescope.codegen.lombok.fixtures.BuilderUserPath");
      assertNotNull(pathClass);
    ...
    void valueBuilderPath() throws Exception {
      final var pathClass = Class.forName("org.telescope.codegen.lombok.fixtures.ValueBuilderUserPath");
      assertNotNull(pathClass);
    ...
    void containerStepDescendsIntoSubPath() throws Exception {
      final var teamPath = Class.forName("org.telescope.codegen.lombok.fixtures.DataTeamPath");
      assertNotNull(teamPath);

      final var membersStep = Class.forName("org.telescope.codegen.lombok.fixtures.DataTeamMembersStep");
      ...
      assertEquals(
        "org.telescope.codegen.lombok.fixtures.DataUserPath",
